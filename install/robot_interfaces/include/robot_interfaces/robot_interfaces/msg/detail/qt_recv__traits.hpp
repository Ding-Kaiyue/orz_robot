...
struct has_fixed_size<robot_interfaces::msg::QtRecv>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Pose>::value && has_fixed_size<std_msgs::msg::Int32MultiArray>::value> {};

template<>
struct has_bounded_size<robot_interfaces::msg::QtRecv>
  : std::integral_constant<bool, has_bounded_size<geometry_msgs::msg::Pose>::value && has_bounded_size<std_msgs::msg::Int32MultiArray>::value> {};
