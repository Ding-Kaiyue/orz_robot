...
robot_interfaces__msg__QtRecv__init(robot_interfaces__msg__QtRecv * msg)
{
  ...
  // working_mode
  // joint_angles_goal
  if (!std_msgs__msg__Int32MultiArray__init(&msg->joint_angles_goal)) {
    robot_interfaces__msg__QtRecv__fini(msg);
    return false;
  }
  // arm_pose_goal
  if (!geometry_msgs__msg__Pose__init(&msg->arm_pose_goal)) {
    robot_interfaces__msg__QtRecv__fini(msg);
    return false;
  }
  return true;
...
robot_interfaces__msg__QtRecv__fini(robot_interfaces__msg__QtRecv * msg)
{
  ...
  // working_mode
  // joint_angles_goal
  std_msgs__msg__Int32MultiArray__fini(&msg->joint_angles_goal);
  // arm_pose_goal
  geometry_msgs__msg__Pose__fini(&msg->arm_pose_goal);
}
