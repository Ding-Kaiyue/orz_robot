...
#include "robot_interfaces/msg/detail/arm_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::msg::ArmState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: end_effector_pose
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.end_effector_pose,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::ArmState & ros_message)
{
  // Member: end_effector_pose
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.end_effector_pose);
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    ...
    ros_message.end_effector_pose, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_interfaces::msg::ArmState;
    is_plain =
      (
      offsetof(DataType, end_effector_pose) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::ArmState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::ArmState *>(
    untyped_ros_message);
...
get_message_type_support_handle<robot_interfaces::msg::ArmState>()
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_ArmState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, ArmState)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_ArmState__handle;
}
