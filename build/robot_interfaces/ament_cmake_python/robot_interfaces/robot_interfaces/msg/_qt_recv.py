...
class Metaclass_QtRecv(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if Int32MultiArray.__class__._TYPE_SUPPORT is None:
                Int32MultiArray.__class__.__import_type_support__()
...
class QtRecv(metaclass=Metaclass_QtRecv):
    ...
    _fields_and_field_types = {
        'working_mode': 'uint8',
        'joint_angles_goal': 'std_msgs/Int32MultiArray',
        'arm_pose_goal': 'geometry_msgs/Pose',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Int32MultiArray'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Int32MultiArray
        self.joint_angles_goal = kwargs.get('joint_angles_goal', Int32MultiArray())
        from geometry_msgs.msg import Pose
        self.arm_pose_goal = kwargs.get('arm_pose_goal', Pose())
    ...
    def joint_angles_goal(self, value):
        if __debug__:
            from std_msgs.msg import Int32MultiArray
            assert \
                isinstance(value, Int32MultiArray), \
                "The 'joint_angles_goal' field must be a sub message of type 'Int32MultiArray'"
    ...
    def arm_pose_goal(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'arm_pose_goal' field must be a sub message of type 'Pose'"
