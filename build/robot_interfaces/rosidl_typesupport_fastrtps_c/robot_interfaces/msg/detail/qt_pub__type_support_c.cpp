...
#include "rosidl_runtime_c/primitives_sequence.h"  // joint_group_positions
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // joint_group_positions
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, joint_group_positions) +
      last_member_size
      ) == ret_val;
  }
